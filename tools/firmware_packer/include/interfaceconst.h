...
#ifndef __INTERFACE__CONST__H__
#define __INTERFACE__CONST__H__ 1

#define MAX_NAME            32      ///
#define TYPE_LEN	        32      ///插件类型名称长度
#define	MAX_FUNCTION		32		///插件函数接口数目
#define MAX_INTERFACE       32      ///插件数目

//------------------------------------------------------------------------------------------------------------
// THE END !
//------------------------------------------------------------------------------------------------------------

#endif //__INTERFACE__CONST__H__
