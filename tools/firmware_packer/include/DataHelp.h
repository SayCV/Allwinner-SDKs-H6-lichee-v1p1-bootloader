...
#ifndef __DATA__HELP__H__
#define __DATA__HELP__H__	1

//------------------------------------------------------------------------------------------------------------
//
//------------------------------------------------------------------------------------------------------------

static u32 u32toLSB(u32 word);

static u16 u16toLSB(u16 half);

static u32 AddSum(u8 * buffer , u32 Length, u32 add_sum_magic);
