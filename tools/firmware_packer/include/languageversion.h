...
#ifndef __LANGUAGE__VERSION_H__
#define __LANGUAGE__VERSION_H__         1

#ifdef SCRIPT_LUA

///当前版本
/*
#include "../../lua512dll_lib/include/lua.hpp"
#pragma comment(lib , "..//..//lua512dll_lib//lua5.1.lib")
*/
